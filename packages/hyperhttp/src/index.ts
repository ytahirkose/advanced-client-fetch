...
export function createHttpAgent(options: NodeAgentOptions = {}): any {
  // This would require Node.js specific imports
  // For now, return a mock that can be used in browser environments
  return {
...
export function createHttpsAgent(options: NodeAgentOptions = {}): any {
  return {
...
export function createNodeTransport(options: NodeAgentOptions = {}): any {
  // This would require Node.js specific fetch implementation
  // For now, return the default fetch
  return fetch;
}

export function createProxyMiddleware(proxyUrl: string): Middleware {
  return async (ctx, next) => {
    // This would require Node.js specific proxy implementation
...
export function streamToNodeReadable(stream: ReadableStream): any {
  // This would require Node.js specific stream conversion
  // For now, return the stream as is
  return stream;
}

export function pipeStreams(...streams: ReadableStream[]): ReadableStream {
  // This would require Node.js specific stream piping
  // For now, return the first stream
  return streams[0];
}
