/**
 * Tests for HyperHTTP Node presets
 */
...
describe('HyperHTTP Node Presets', () => {
  describe('createNodeClient', () => {
    it('should create client with default configuration', () => {
      const client = createNodeClient();
      
      expect(client).toBeDefined();
      expect(client._options.headers['User-Agent']).toBe('hyperhttp-node/0.1.0');
    ...
    it('should handle Node-specific options', () => {
      const client = createNodeClient({
        keepAlive: true,
        maxSockets: 100,
  ...
  describe('createMinimalNodeClient', () => {
    it('should create client with minimal configuration', () => {
      const client = createMinimalNodeClient('https://api.example.com');
  ...
  describe('createFullNodeClient', () => {
    it('should create client with full configuration', () => {
      const client = createFullNodeClient();
