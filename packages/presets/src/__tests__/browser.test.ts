/**
 * Tests for HyperHTTP Browser presets
 */
...
describe('HyperHTTP Browser Presets', () => {
  describe('createBrowserClient', () => {
    it('should create client with default configuration', () => {
      const client = createBrowserClient();
      
      expect(client).toBeDefined();
      expect(client._options.headers['User-Agent']).toBe('hyperhttp-browser/0.1.0');
  ...
  describe('createMinimalBrowserClient', () => {
    it('should create client with minimal configuration', () => {
      const client = createMinimalBrowserClient('https://api.example.com');
  ...
  describe('createFullBrowserClient', () => {
    it('should create client with full configuration', () => {
      const client = createFullBrowserClient();
  ...
  describe('createSPAClient', () => {
    it('should create client optimized for SPA', () => {
  ...
  describe('createPWAClient', () => {
    it('should create client optimized for PWA', () => {
