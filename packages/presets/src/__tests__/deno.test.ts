/**
 * Tests for HyperHTTP Deno presets
 */
...
describe('HyperHTTP Deno Presets', () => {
  describe('createDenoClient', () => {
    it('should create client with default configuration', () => {
      const client = createDenoClient();
      
      expect(client).toBeDefined();
      expect(client._options.headers['User-Agent']).toBe('hyperhttp-deno/0.1.0');
  ...
  describe('createMinimalDenoClient', () => {
    it('should create client with minimal configuration', () => {
      const client = createMinimalDenoClient('https://api.example.com');
  ...
  describe('createFullDenoClient', () => {
    it('should create client with full configuration', () => {
      const client = createFullDenoClient();
